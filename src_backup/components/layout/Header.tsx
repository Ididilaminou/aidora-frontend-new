...
// AIDORA — EN-TÊTE
// ------------------------------------------------------------
// Menu burger, recherche, notifications (dropdown), profil.
// ============================================================
            ...
            return (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-0.5 line-clamp-2 text-xs text-neutral-600 dark:text-neutral-400 dark:text-neutral-500">
                    {n.message}
                  </p>
  ...
  return (
    <header className="sticky top-0 z-20 flex h-16 items-center gap-3 border-b border-neutral-200 bg-white/80 px-4 backdrop-blur-lg dark:border-neutral-800 dark:bg-neutral-900/80 lg:px-6">
      ...
      <button
        ...
        className="rounded-lg p-2 text-neutral-600 dark:text-neutral-400 dark:text-neutral-500 hover:bg-neutral-100 lg:hidden"
      >
        <Menu size={20} />
      </button>
      ...
      <div className="relative hidden flex-1 max-w-md md:block">
        ...
        <input
          ...
          className="h-9 w-full rounded-lg border border-neutral-200 bg-neutral-50 pl-9 pr-3 text-sm outline-none transition focus:border-primary-500 focus:bg-white focus:ring-4 focus:ring-primary-100"
        />
      </div>
          ...
          <button
              ...
              className={cn(
                ...
                menuNotifs
                  ...
                  : "text-neutral-600 dark:text-neutral-400 dark:text-neutral-500 hover:bg-neutral-100 dark:text-neutral-300 dark:hover:bg-neutral-800"
              )}
            >
            <Bell size={18} />
            {nonLues > 0 && (
              <span className="absolute -right-0.5 -top-0.5 flex h-4 min-w-4 items-center justify-center rounded-full bg-primary-500 px-1 text-[10px] font-semibold text-white ring-2 ring-white">
                {nonLues > 9 ? "9+" : nonLues}
              </span>
            )}
          </button>
        ...
        <div ref={refProfil} className="relative">
          ...
          >
            ...
            <div className="hidden text-left leading-tight sm:block">
              ...
              <p className="text-[10px] text-neutral-500 dark:text-neutral-400 dark:text-neutral-500">
          ...
          {menuProfil && (
            <div
              className={cn(
                "absolute right-0 mt-2 w-56 overflow-hidden rounded-xl border border-neutral-200 bg-white shadow-float",
                "animate-scale-in"
              )}
            >
              <div className="border-b border-neutral-100 px-4 py-3">
                ...
                <p className="truncate text-xs text-neutral-500 dark:text-neutral-400 dark:text-neutral-500">
                  {utilisateur?.email}
                </p>
              </div>

              <div className="p-1.5">
                <button className="flex w-full items-center gap-2.5 rounded-lg px-3 py-2 text-sm text-neutral-700 dark:text-neutral-300 transition hover:bg-neutral-100">
                  <UserIcon size={16} />
                  Mon profil
                </button>
                <button
                  ...
                  className="flex w-full items-center gap-2.5 rounded-lg px-3 py-2 text-sm text-neutral-700 dark:text-neutral-300 transition hover:bg-neutral-100"
                >
                  <Settings size={16} />
                  Paramètres
                </button>
              ...
              <div className="border-t border-neutral-100 p-1.5">
                <button
                  ...
                  className="flex w-full items-center gap-2.5 rounded-lg px-3 py-2 text-sm text-danger-700 transition hover:bg-danger-50"
                >
                  <LogOut size={16} />
                  Se déconnecter
                </button>
