              ...
              <button
                ...
                className={`flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition ${
                  onglet === o.id
                    ...
                    : "text-neutral-600 dark:text-neutral-400 dark:text-neutral-500 hover:bg-neutral-100 hover:text-neutral-900 dark:text-white"
                }`}
              >
                <o.icone size={16} />
                {o.label}
      ...
      <Card>
        <div className="flex items-center gap-4">
          ...
          <div className="min-w-0">
            ...
            <p className="truncate text-sm text-neutral-500 dark:text-neutral-400 dark:text-neutral-500">
              {utilisateur?.email}
            </p>
        ...
        {items.map((it) => (
          <div key={it.cle} className="flex items-center justify-between py-4">
            <div>
              ...
              <p className="text-xs text-neutral-500 dark:text-neutral-400 dark:text-neutral-500">{it.desc}</p>
            </div>
            <button
              role="switch"
...
function Ligne({ label, valeur }: { label: string; valeur: string }) {
  return (
    <div className="flex justify-between border-b border-neutral-100 pb-2 last:border-0">
      <span className="text-neutral-500 dark:text-neutral-400 dark:text-neutral-500">{label}</span>
