...
const ICONES: Record<string, typeof LayoutDashboard> = {
  ...
  [ROUTES.CARTE]:          MapPin,           // admin
  [ROUTES.CARTE_LOCALE]:   MapPinned,        // personnel banque/hôpital
  ...
  [ROUTES.SOLLICITATIONS]: Send,
  // Donneur
  [ROUTES.DONNEUR_PROFIL]:        UserCircle2,
  [ROUTES.DONNEUR_CARTE]:         IdCard,
  [ROUTES.DONNEUR_EVALUATION]:    Brain,
  [ROUTES.DONNEUR_DONS]:          HeartHandshake,
  [ROUTES.DONNEUR_PRENDRE_RDV]:   CalendarPlus,
                    ...
                    className={({ isActive }) =>
                      cn(
                        ...
                        isActive
                          ...
                          : "text-neutral-600 dark:text-neutral-400 hover:bg-neutral-100 hover:text-neutral-900 dark:text-neutral-400 dark:hover:bg-neutral-800 dark:hover:text-white",
        ...
        {onToggleReduite && (
          <div className="border-t border-neutral-100 p-3 dark:border-neutral-800">
            <button
              ...
              className={cn(
                "flex w-full items-center gap-2 rounded-lg px-3 py-2 text-xs font-medium text-neutral-500 dark:text-neutral-400",
